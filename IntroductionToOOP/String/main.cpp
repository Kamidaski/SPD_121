...
str1[2] = 0;*/
	...
	String str3 = str2;  //CopyConstractor
	str3.print();

	String str4();	//Defauld constructor //Здесь не вызывается конструктор по умолчанию, поскольку здесь не создаётся никаких объектов
	//Обьявляем функцию str4(), Котороая не принемает никаких параметров и не возвращает значение
